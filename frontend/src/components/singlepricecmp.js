const Singleprice = ({ priceToDisplay }) => {
  return (
    <div className="flex flex-col justify-center items-center mt-4 w-full max-w-[44em] border border-gray-300 h-[7em] rounded-xl bg-black text-white font-extralight p-4">
